...
( function ( ) {
	...
	function create ( _canvas = undefined ) {
	...
	this.render = function ( _code = undefined ) {

		if(typeof _code !== 'undefined' && typeof _code === 'object'){
			if(_code.constructor.name !== 'MouseEvent'){
				code = _code
			}
		}
